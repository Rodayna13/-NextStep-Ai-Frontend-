...
import CustomAssistant from '../CustomAssistant/CustomAssistant';
...
import { generateSystemPrompt, generateSystemPromptForJob, getInitialGreeting } from './utils/promptGenerator';

const InterviewPracticeSession = ({ cvData, jobDescription }) => {
    ...
    const [aiVoiceImage, setAiVoiceImage] = useState('')
    console.log('passed ' + jobDescription);
    console.log('passed cvData' + cvData);
    const {
        history,
        isProcessing,
        setAssistantConfig,
    ...
    const handleStartSession = (config) => {
        ...
        setAiVoiceImage(config.voiceImage);
        ...
        setTimeout(async () => {
            const systemPrompt = await (jobDescription ? generateSystemPromptForJob(config, jobDescription) : generateSystemPrompt(config, cvData));
