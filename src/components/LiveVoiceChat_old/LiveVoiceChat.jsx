    ...
    <div className={`main-container ${isVisible ? "visible" : "hidden"}`}>
      ...
      <div className="split">
        ...
        <div className={`left flex-col items-center justify-center gap-8 ${isUserSpeaking ? "speaking" : ""}`}>
          <div className={`avatar user-avatar user-avatar-bg ${isUserSpeaking ? "speaking-avatar" : ""}`}></div>
          ...
          <div className={`interim-transcript ${
            speechRecognition.interim || speechRecognition.transcript ? "visible" : ""
          }`}>
        ...
        <div className={`right flex-col items-center justify-center gap-8 ${isAiSpeaking ? "speaking" : ""}`}>
          <div className={`avatar ai-avatar ai-avatar-bg ${isAiSpeaking ? "speaking-avatar" : ""}`}></div>
